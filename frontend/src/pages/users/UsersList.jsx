...
import { apiFetch, getMediaUrl, BACKEND_URL, API_BASE_URL } from '../../utils/api';
      ...
      render: (r) => {
        ...
        return (
          <div className="d-flex align-items-center gap-2">
            {pic ? (
              <img src={getMediaUrl(pic)} alt={r.name} style={{ width: 28, height: 28, borderRadius: '50%', objectFit: 'cover', border: '1px solid var(--border)' }} />
            ) : (
    ...
    },
    {
      ...
      render: (r) => {
        ...
        return (
          <div className="d-flex align-items-center gap-2">
            {logo ? (
              <img src={getMediaUrl(logo)} alt="Logo" style={{ width: 20, height: 20, objectFit: 'contain', borderRadius: 4 }} />
            ) : (
          ...
          <div className="d-flex align-items-center gap-3 mb-3 pb-3 border-bottom">
            <div className="avatar avatar-xl tone-blue position-relative" style={{ width: 60, height: 60, borderRadius: '50%', overflow: 'hidden', border: '2px solid var(--border)', flexShrink: 0 }}>
              {(form.profile_pic || form.profilePic) ? (
                <img
                  src={getMediaUrl(form.profile_pic || form.profilePic)}
                  alt="Profile"
                ...
                <div className="position-relative">
                  {viewUser.profile_pic ? (
                    <div className="avatar avatar-xl" style={{ width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', border: '2px solid var(--border)' }}>
                      <img src={getMediaUrl(viewUser.profile_pic)} alt={viewUser.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                  ) : (
                  ...
                  {logo && (
                    <div style={{ position: 'absolute', bottom: -2, right: -2, width: 26, height: 26, borderRadius: '50%', background: '#fff', boxShadow: '0 1px 4px rgba(0,0,0,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', padding: 2 }}>
                      <img src={getMediaUrl(logo)} alt="Company Logo" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                    </div>
                  )}
                </div>
                <div>
